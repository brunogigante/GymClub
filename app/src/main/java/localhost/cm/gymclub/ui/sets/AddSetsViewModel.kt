...
class AddSetsViewModel @Inject constructor(private val dataRepository: DataRepository): ViewModel() {
    ...
    fun addNewSetToExercise(setId: Int, reps: Int, weight: Int, workoutId: Int, exerciseId: Int) {
        viewModelScope.launch {
            dataRepository.createExerciseSet(setId, reps, weight, workoutId, exerciseId)
        }
    }
}